...
app.config['MYSQL_DATABASE_HOST'] = 'rivondave.mysql.pythonanywhere-services.com'
app.config['MYSQL_DATABASE_USER'] = 'rivondave'
app.config['MYSQL_DATABASE_DB'] = 'rivondave$kidsfashion'
app.config['MYSQL_DATABASE_PASSWORD'] = 'kids456#'
